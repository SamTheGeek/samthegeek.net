...
This document captures completed milestones and prior status notes that no longer need to live in `STATUS.md`.
...
- Documented all scripts in `README.md` and `Docs/DOWNLOAD_IMAGES_README.md`.
